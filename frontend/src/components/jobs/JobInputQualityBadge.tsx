...
import type { JobInputQualityLevel } from "./JobInputQualitySummary";

const STYLES: Record<JobInputQualityLevel, { bg: string; color: string }> = {
...
interface Props {
  level: JobInputQualityLevel;
}

export function JobInputQualityBadge({ level }: Props) {
