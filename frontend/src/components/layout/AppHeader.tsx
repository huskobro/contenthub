...
export function AppHeader({ area }: AppHeaderProps) {
  ...
  return (
    <header
      className="flex items-center h-header px-6 border-b border-border-subtle bg-[rgba(255,255,255,0.85)] backdrop-blur-[12px] shadow-sm z-header shrink-0"
    >
      <span
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1 text-sm font-body text-neutral-500 bg-surface-inset border border-border-subtle rounded-lg cursor-pointer mr-3 transition-all duration-fast hover:border-brand-400 hover:shadow-[0_0_0_2px_rgba(76,110,245,0.1)]"
      >
      ...
      <button
        ...
        className="px-3 py-1 text-sm font-medium font-body text-neutral-600 bg-transparent border border-border rounded-md cursor-pointer transition-all duration-fast hover:bg-neutral-50 hover:border-brand-400 hover:shadow-[0_0_0_2px_rgba(76,110,245,0.08)]"
      >
        {config.switchLabel}
      </button>
    </header>
