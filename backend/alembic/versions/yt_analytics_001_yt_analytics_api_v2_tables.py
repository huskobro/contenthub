...
def upgrade() -> None:
    if not _table_exists("youtube_channel_analytics_daily"):
        op.create_table(
            "youtube_channel_analytics_daily",
    ...
    if not _index_exists("ix_yt_channel_analytics_daily_conn"):
        op.create_index(
            "ix_yt_channel_analytics_daily_conn",
            "youtube_channel_analytics_daily",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_channel_analytics_daily_date"):
        op.create_index(
    ...
    if not _table_exists("youtube_video_analytics_daily"):
        op.create_table(
            "youtube_video_analytics_daily",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_video_analytics_daily_conn"):
        op.create_index(
            "ix_yt_video_analytics_daily_conn",
            "youtube_video_analytics_daily",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_video_analytics_daily_vid"):
        op.create_index(
            "ix_yt_video_analytics_daily_vid",
            "youtube_video_analytics_daily",
            ["platform_video_id"],
        )
    if not _index_exists("ix_yt_video_analytics_daily_date"):
        op.create_index(
    ...
    if not _table_exists("youtube_audience_retention"):
        op.create_table(
            "youtube_audience_retention",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_retention_conn"):
        op.create_index(
            "ix_yt_retention_conn",
            "youtube_audience_retention",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_retention_vid"):
        op.create_index(
            "ix_yt_retention_vid",
            "youtube_audience_retention",
            ["platform_video_id"],
    ...
    if not _table_exists("youtube_demographics_snapshot"):
        op.create_table(
            "youtube_demographics_snapshot",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_demographics_conn"):
        op.create_index(
            "ix_yt_demographics_conn",
            "youtube_demographics_snapshot",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_demographics_vid"):
        op.create_index(
    ...
    if not _table_exists("youtube_traffic_source_snapshot"):
        op.create_table(
            "youtube_traffic_source_snapshot",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_traffic_conn"):
        op.create_index(
            "ix_yt_traffic_conn",
            "youtube_traffic_source_snapshot",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_traffic_vid"):
        op.create_index(
            "ix_yt_traffic_vid",
            "youtube_traffic_source_snapshot",
            ["platform_video_id"],
    ...
    if not _table_exists("youtube_device_snapshot"):
        op.create_table(
            "youtube_device_snapshot",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_device_conn"):
        op.create_index(
            "ix_yt_device_conn",
            "youtube_device_snapshot",
            ["platform_connection_id"],
        )
    if not _index_exists("ix_yt_device_vid"):
        op.create_index(
            "ix_yt_device_vid",
            "youtube_device_snapshot",
            ["platform_video_id"],
    ...
    if not _table_exists("youtube_analytics_sync_log"):
        op.create_table(
            "youtube_analytics_sync_log",
            sa.Column("id", sa.String(36), primary_key=True),
            sa.Column("platform_connection_id", sa.String(36), nullable=False),
    ...
    if not _index_exists("ix_yt_analytics_sync_log_conn"):
        op.create_index(
