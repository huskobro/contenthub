...
KNOWN_SETTINGS: Dict[str, Dict[str, Any]] = {
    ...
    "provider.llm.kie_temperature": {
        ...
        "help_text": "LLM yaraticilik seviyesi. 0.0 = deterministik, 1.0 = yaratici.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 0.7,
        "wired": True,
        "wired_to": "KieAiProvider temperature parametresi",
    },
    "provider.llm.openai_model": {
        ...
        "wired": True,
        "wired_to": "OpenAICompatProvider model secimi — startup + runtime reinit",
    },
    "provider.llm.openai_temperature": {
        ...
        "builtin_default": 0.7,
        "wired": True,
        "wired_to": "OpenAICompatProvider temperature parametresi",
    },
    "provider.llm.timeout_seconds": {
        ...
        "wired": True,
        "wired_to": "OpenAI compat base HTTP client timeout",
    },
    "provider.tts.edge_default_voice": {
        ...
        "wired": True,
        "wired_to": "EdgeTTSProvider varsayilan ses — TTS step",
    },
    "provider.visuals.pexels_default_count": {
        ...
        "builtin_default": 5,
        "wired": True,
        "wired_to": "PexelsProvider arama sonuc limiti",
    },
    "provider.visuals.pixabay_default_count": {
        ...
        "builtin_default": 5,
        "wired": True,
        "wired_to": "PixabayProvider arama sonuc limiti",
    },
    "provider.visuals.search_timeout_seconds": {
        ...
        "wired": True,
        "wired_to": "Pexels/Pixabay arama HTTP timeout",
    },
    "provider.whisper.model_size": {
        "group": "providers",
        "type": "string",
        "label": "Whisper Model Boyutu",
        "help_text": "Yerel Whisper transkripsiyon model boyutu. tiny/base/small/medium/large",
        "module_scope": "standard_video",
        "env_var": "",
        "builtin_default": "base",
        "wired": True,
        "wired_to": "LocalWhisperProvider model yuklemesi",
    },
    ...
    "source_scans.soft_dedupe_threshold": {
        ...
        "help_text": "Baslik benzerlik esigi (0.0-1.0). Dusurulurse daha fazla haber dedupe edilir.",
        "module_scope": "news_bulletin",
        "env_var": "",
        "builtin_default": 0.65,
        "wired": True,
        "wired_to": "dedupe_service Jaccard similarity threshold",
    },
    ...
    "publish.youtube.upload_timeout_seconds": {
        ...
        "builtin_default": 60.0,
        "wired": True,
        "wired_to": "YouTubeAdapter HTTP client timeout",
    },
}
