...
KNOWN_SETTINGS: Dict[str, Dict[str, Any]] = {
    ...
    "provider.llm.kie_model": {
        ...
        "help_text": "Kie.ai uzerinden kullanilacak LLM model adi. Provider kendi default'unu kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": "gemini-2.5-flash",
        "wired": False,
        "wired_to": "DEFINED — KieAiProvider henuz bu ayari resolve() ile okumuyor",
    },
    "provider.llm.kie_temperature": {
        "group": "providers",
        "type": "float",
        "label": "Kie.ai LLM Temperature",
        "help_text": "LLM yaraticilik seviyesi. Provider kendi default'unu kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 0.7,
        "wired": False,
    ...
    "provider.llm.openai_temperature": {
        ...
        "help_text": "OpenAI fallback LLM yaraticilik seviyesi. Provider kendi default'unu kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 0.7,
        "wired": False,
        "wired_to": "DEFINED — OpenAICompatProvider henuz bu ayari resolve() ile okumuyor",
    },
    "provider.llm.timeout_seconds": {
        "group": "providers",
        "type": "float",
        "label": "LLM HTTP Timeout (saniye)",
        "help_text": "LLM API cagrilarinda HTTP timeout suresi. _openai_compat_base kendi default'unu kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 60.0,
        "wired": False,
        "wired_to": "DEFINED — _openai_compat_base.py henuz bu ayari resolve() ile okumuyor",
    },
    "provider.tts.edge_default_voice": {
        "group": "providers",
        "type": "string",
        "label": "Edge TTS Varsayilan Ses",
        "help_text": "Edge TTS icin varsayilan ses profili. Provider kendi _VARSAYILAN_SES degerini kullaniyor.",
        "module_scope": "standard_video",
        "env_var": "",
        "builtin_default": "tr-TR-AhmetNeural",
        "wired": False,
        "wired_to": "DEFINED — EdgeTTSProvider henuz bu ayari resolve() ile okumuyor",
    },
    "provider.visuals.pexels_default_count": {
        "group": "providers",
        "type": "integer",
        "label": "Pexels Varsayilan Gorsel Sayisi",
        "help_text": "Pexels aramasinda varsayilan sonuc sayisi. Provider kendi _VARSAYILAN_ADET degerini kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 5,
        "wired": False,
        "wired_to": "DEFINED — PexelsProvider henuz bu ayari resolve() ile okumuyor",
    },
    "provider.visuals.pixabay_default_count": {
        "group": "providers",
        "type": "integer",
        "label": "Pixabay Varsayilan Gorsel Sayisi",
        "help_text": "Pixabay aramasinda varsayilan sonuc sayisi. Provider kendi _VARSAYILAN_ADET degerini kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 5,
        "wired": False,
        "wired_to": "DEFINED — PixabayProvider henuz bu ayari resolve() ile okumuyor",
    },
    "provider.visuals.search_timeout_seconds": {
        "group": "providers",
        "type": "float",
        "label": "Gorsel Arama Timeout (saniye)",
        "help_text": "Gorsel provider HTTP arama timeout suresi. Provider kendi hardcoded timeout degerini kullaniyor.",
        "module_scope": None,
        "env_var": "",
        "builtin_default": 30.0,
        "wired": False,
        "wired_to": "DEFINED — Pexels/Pixabay provider'lar henuz bu ayari resolve() ile okumuyor",
    },
    ...
    "source_scans.soft_dedupe_threshold": {
        ...
        "help_text": "Baslik benzerlik esigi (0.0-1.0). Dedupe servisi kendi hardcoded degerini kullaniyor.",
        "module_scope": "news_bulletin",
        "env_var": "",
        "builtin_default": 0.65,
        "wired": False,
        "wired_to": "DEFINED — dedupe_service henuz bu ayari resolve() ile okumuyor",
    },
