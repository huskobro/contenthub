...
from app.modules.product_review.router import router as product_review_router
...
from app.publish.youtube.engagement_advanced_router import router as youtube_engagement_advanced_router
...
api_router.include_router(standard_video_router, dependencies=[Depends(require_user)])
...
api_router.include_router(product_review_router, dependencies=[Depends(require_user)])
