...
async def test_template_style_links_table_exists(test_engine):
    ...
    assert "template_style_links" in tables, "template_style_links table should exist after migration"
